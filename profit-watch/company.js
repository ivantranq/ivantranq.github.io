...
function companyDescriptionHTML(description, quote) {
    return descriptionAvailable(description, quote) + `<div class="company-quote">
...
function descriptionAvailable(description, quote) {
    if (typeof description !== 'undefined') {
        return `<div class="company-description">
                    <h1 class="company-description__heading">${quote.ticker}</h1>
                    ...
                    <h2 class="company-description__industry-sector">${description.industry} - ${description.sector}</h2>
